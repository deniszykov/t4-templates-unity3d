...
namespace GameDevWare.TextTransform.Editor.Processor.RoslynCodeProvider
{
	...
	public sealed class CSharpCodeProvider : Microsoft.CSharp.CSharpCodeProvider
	{
		...
		{
			this._providerOptions = compilerSettings == null ? CompilationUtil.CSC2 : new ProviderOptions(compilerSettings);
		}
		...
		{
			this._providerOptions = providerOptions ?? CompilationUtil.CSC2;
		}
		...
		{
			return new CSharpCompiler(this, this._providerOptions);
		}
	}
}
