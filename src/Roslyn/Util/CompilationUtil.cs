...
namespace Microsoft.CodeDom.Providers.DotNetCompilerPlatform
{
	internal static class CompilationUtil
	{
		...
		public static IProviderOptions GetProviderOptionsFor(string fileExt)
		{
			...
			// CompilerFullPath
			//
			string compilerFullPath = String.Empty;
			...
			if (fileExt.Equals(".cs", StringComparison.InvariantCultureIgnoreCase))
				compilerFullPath = GameDevWare.TextTransform.UnityTemplateCompilationSettings.RoslynCompilerPath ?? Path.Combine(compilerFullPath, "csc.exe");
